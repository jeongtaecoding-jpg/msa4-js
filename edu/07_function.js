...
// 매개변수(parameter) : 함수 정의에서 전달 받는 argument를 저장하는 변수인(소괄호 안) a와 b
function fnc1(a, b) {
  let sum = a + b;
...
// 인수(argument) : 함수 호출에서 전달되는 값인(소괄호 안) 1과 2
let result = fnc1(1, 2);
console.log(result);
...
// func3(1,1) // 참조 에러 발생(fnc3이 위에 정의되어 있음)
...
callBackTest(true, () => console.log('ttttt0'));

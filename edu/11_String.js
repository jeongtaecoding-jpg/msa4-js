...
console.log(str6.replace('문자', '돈까스'));
...
// String.split(startIdx, endIdx) : Array
...
// String.trim() : String
//    문자열에서 시작과 끝의 공백을 제거한 문자열을 반환(글자 사이는 제외)
let str10 = '         아  아아   ';
console.log(str10);
...
//    문자열을 대소문자로 변경해서 반환
let str11 = 'dfsfAASDJjjlJLnhlJNjnLNLKnkftf';

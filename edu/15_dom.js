// 요소 선택 메소드
// const 변수명 = document.메소드명('선택할 요소');  
// 변수명.style.스타일속성 (= 변수, 메소드)
...
// 해당 요소들을 HTMLCollction 객체(배열)로 획득
...
//  태그는 태그로 인식해서 전달
title1.textContent = '<p>p태그</p>';   // 이렇게 하면 태그로 인식이 안되고 그냥 글임
...
//    요소의 특정 속성을 제거
setAttrInput.removeAttribute('placeholder');   // 'js에서 추가' placeholder가 없어진다.
...
title1.classList.toggle('display-none');   // 클래스 토글(안에는 하나만 가능)
...
// parentContainer.removeChild(newH3);   // 짬뽕 제거
